...
| **Vicmap fire stations** (1,705 stations — 1,288 VIC, 334 NSW, 81 SA border overlap) | `vicmap-emergency/` | **CC BY 4.0** | ✅ (attribution required) | "Vicmap Features of Interest © State of Victoria (DEECA)" |
